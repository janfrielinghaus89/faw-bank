    ...
    <div class="row-2">
        <div class="col-3 col-s-3 col-3-text">
		    ...
		    <div class="col-9 col-9-text">
                ...
                <h3>Privatkunden anlegen</h3>
                <form id="privatanlegen" action="privatkunde.php" method="post">
                ...
                <p class="col-9-kundenbereich">                
                    ...
                    if(isset($_POST['kundeanlegen']) && strlen($_POST['name']) > 0){
                        ...
                        $fawBank->kunden_hinzufügen($_POST['name'], $_POST['vorname'], $adresse->strasse, $adresse->hausnummer, $adresse->plz, $adresse->stadt, "Privatkunde");
                    }
