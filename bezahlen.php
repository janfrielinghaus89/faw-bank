<?php
    ...
    require_once('includes/kreditkarte.inc.php');
?>
    ...
    <div class="row-2">
        <div class="col-3 col-s-3 col-3-text">
		    ...
		    <div class="col-9 col-9-text">
                ...
                <h3>Mit Kreditkarte bezahlen</h3>
                <form id="bezahlen" action="bezahlen.php" method="post">
                    <label for="text">Kontonummer: </label><input type="text" id="kartennummer" name="kartennummer" placeholder="000000000000" required><br>
                ...
                <p class="col-9-kundenbereich">
                    ...
                    if(isset($_POST['bezahlen']) && strlen($_POST['summe']) > 0){
                        // Einzahlung tätigen
                        $kreditkarte->bezahlen($_POST['kartennummer'], $_POST['summe']);
                    }
                    ?>   
                </p>
            </div>
