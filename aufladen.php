    ...
    <div class="row-2">
        <div class="col-3 col-s-3 col-3-text">
		    ...
		    <div class="col-9 col-9-text">
                ...
                <h3>Kreditkarte aufladen</h3>
                <form id="aufladen" action="aufladen.php" method="post">
                ...
                <p class="col-9-kundenbereich">
                    ...
                    if(isset($_POST['aufladen']) && strlen($_POST['summe']) > 0){
                        // Einzahlung tätigen
                        $kreditkarte->aufladen($_POST['kartennummer'], $_POST['summe']);
                    }
                    ?>   
                </p>
            </div>
